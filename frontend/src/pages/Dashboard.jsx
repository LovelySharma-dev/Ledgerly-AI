                        ...
                        <td className={dashboardStyles.tableCell} >
                          <div className="text-right">
                            <button onClick={(e) => {
                              ...
                              <EyeIcon className="w-4 h-4 group-hover/btn:scale-110 transition-transform"/> View
                            </button>
                          </div>
                        </td>
                    ...
                    <tr>
                      <td colSpan="5" className={dashboardStyles.emptyState}>
                        <div className={dashboardStyles.emptyStateText}>
                          ...
                          <div className={dashboardStyles.emptyStateAction}>No Invoice yet
