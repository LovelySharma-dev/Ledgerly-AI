...
// Brand:      Indigo    #4F46E5  (CTAs, active states, brand accent)
// Brand pop:  Fuchsia   #C026D3  (gradient partner — signature CTA glow)
...
// Signature:  every primary action uses an indigo → fuchsia gradient instead
// of a flat fill, so the product reads warmer and more crafted than a
// default admin-panel palette.
// ─────────────────────────────────────────────────────────────────────────────
...
export const aiInvoiceModalStyles = {
  ...
  textarea:
    "w-full rounded-xl border text-slate-600 border-slate-200 px-3 py-2.5 text-sm resize-vertical focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200 bg-slate-50/50",
  ...
  generateButton:
    "px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white text-sm font-medium hover:from-indigo-500 hover:to-fuchsia-500 transition-colors disabled:opacity-50",
};

export const businessProfileStyles = {
  // Layout
  pageContainer: "space-y-10",
  ...
  input:
    "w-full rounded-xl border border-slate-200 px-4 py-3 bg-slate-50/50 focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200 text-slate-800 placeholder:text-slate-400",
  textarea:
    "w-full rounded-xl border border-slate-200 px-4 py-3 bg-slate-50/50 focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200 text-slate-800 placeholder:text-slate-400",

  // Upload Areas
  uploadArea:
    "border-2 border-dashed border-slate-200 rounded-2xl p-6 transition-all duration-300 hover:border-indigo-400 hover:bg-indigo-50/30 group",
  uploadIconContainer:
    "w-16 h-16 mx-auto rounded-2xl bg-slate-100 flex items-center justify-center text-slate-400 group-hover:bg-indigo-100 group-hover:text-indigo-500 transition-all duration-300",
  uploadSmallIconContainer:
    "w-12 h-12 mx-auto rounded-xl bg-slate-100 flex items-center justify-center text-slate-400 group-hover:bg-indigo-100 group-hover:text-indigo-500 transition-all duration-300",
  ...
  changeButton:
    "inline-flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2 md:px-5 md:py-2.5 rounded-xl bg-indigo-50 text-indigo-700 hover:bg-indigo-100 transition-all duration-200 cursor-pointer font-medium text-sm sm:text-base",
  removeButton:
  ...
  // Tax Section
  taxContainer: "bg-indigo-50/50 rounded-2xl p-6 border border-indigo-100",
  taxInput:
    "w-32 rounded-xl border border-slate-200 px-4 py-3 bg-white focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200 font-medium text-center text-slate-800",
  ...
  saveButton:
    "inline-flex items-center gap-2 px-4 py-2 sm:px-6 sm:py-3 md:px-7 md:py-3.5 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white font-semibold text-sm sm:text-base hover:from-indigo-500 hover:to-fuchsia-500 active:scale-[0.98] transition-all duration-200 shadow-lg shadow-indigo-500/20 disabled:opacity-50 disabled:cursor-not-allowed",
  resetButton:
...
export const aiReminderModalStyles = {
  ...
  textarea:
    "mt-1 w-full text-slate-600 rounded-xl border border-slate-200 px-3 py-2.5 text-sm bg-slate-50/50 focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200",
  ...
  previewPlaceholderHighlight: "font-medium text-indigo-500",
  ...
  generateButton:
    "px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white text-sm font-medium hover:from-indigo-500 hover:to-fuchsia-500 transition-colors",
};
...
export const createInvoiceStyles = {
  ...
  input:
    "w-full rounded-xl border border-slate-200 px-4 py-3 bg-slate-50/50 focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200 text-slate-800 placeholder:text-slate-400",
  inputMedium:
    "w-full rounded-xl border border-slate-200 px-4 py-3 bg-slate-50/50 focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200 font-medium text-slate-800",
  inputCenter:
    "w-full rounded-xl border border-slate-200 px-4 py-3 bg-slate-50/50 focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200 text-center font-medium text-slate-800",
  textarea:
    "w-full rounded-xl border border-slate-200 px-4 py-3 bg-slate-50/50 focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200 text-slate-800 placeholder:text-slate-400",
  inputSmall:
    "w-full rounded-xl border text-slate-500 border-slate-200 px-4 py-3 bg-slate-50/50 focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200 text-sm",
  ...
  saveButton:
    "inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white font-semibold hover:from-indigo-500 hover:to-fuchsia-500 active:scale-[0.98] transition-all duration-200 shadow-lg shadow-indigo-500/20 disabled:opacity-50 disabled:cursor-not-allowed",
  saveProfileButton:
    "inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-50 text-indigo-700 hover:bg-indigo-100 transition-all duration-200 text-sm font-medium",
  addItemButton:
    "inline-flex items-center gap-2 px-6 py-3 rounded-xl border-2 border-dashed border-slate-200 text-slate-500 hover:border-indigo-400 hover:text-indigo-600 hover:bg-indigo-50/30 transition-all duration-200 font-medium w-full justify-center group",
  ...
  statusDropdown:
    "mt-2 sm:hidden w-full px-3 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200",
  ...
  itemsTableRow:
    "grid grid-cols-6 sm:grid-cols-12 lg:grid-cols-12 gap-4 items-center group hover:bg-indigo-50/30 p-3 rounded-xl transition-all duration-200 min-w-0",
  itemsInput:
    "rounded-xl border border-slate-200 px-4 py-3 bg-slate-50/50 focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200 w-full min-w-0 overflow-hidden truncate text-sm sm:text-base text-slate-800",
  itemsNumberInput:
    "rounded-xl border border-slate-200 px-3 py-3 bg-slate-50/50 focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200 text-right w-full min-w-0 overflow-x-auto whitespace-nowrap text-sm sm:text-base text-slate-800",
  itemsTotal:
  ...
  changeButton:
    "inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-indigo-50 text-indigo-700 hover:bg-indigo-100 transition-all duration-200 cursor-pointer text-sm font-medium",
  removeButton:
  ...
  uploadIconContainer:
    "w-12 h-12 mx-auto rounded-xl bg-slate-100 flex items-center justify-center text-slate-400 group-hover:bg-indigo-100 group-hover:text-indigo-500 transition-all duration-300",
  uploadSmallIconContainer:
    "w-10 h-10 mx-auto rounded-xl bg-slate-100 flex items-center justify-center text-slate-400 group-hover:bg-indigo-100 group-hover:text-indigo-500 transition-all duration-300",
  uploadTextTitle: "text-sm font-medium text-slate-800",
  uploadTextSubtitle: "text-xs text-slate-400 mt-1",
  ...
  totalValue: "text-lg font-bold text-indigo-700",
...
export const appShellStyles = {
  // Layout
  root: "min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/40",
  ...
  sidebarGradient:
    "absolute inset-0 bg-gradient-to-b from-indigo-900/10 to-transparent pointer-events-none",
  sidebarContainer:
  ...
  logoUnderline:
    "h-0.5 w-0 group-hover:w-full bg-indigo-400 transition-all duration-500 mt-1",
  collapseButton:
  ...
  mobileSidebar:
    "absolute inset-y-0 left-0 w-72 bg-gradient-to-b from-[#0F172A] to-[#161B33] border-r border-white/5 p-6 overflow-auto transform transition-transform duration-300",
  ...
  welcomeName: "text-indigo-600",
  welcomeSubtitle: "text-xs sm:text-sm text-slate-500 mt-0.5 sm:mt-1",
  mobileUserAvatar: "lg:hidden flex items-center gap-2",
  mobileAvatar:
    "w-8 h-8 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 flex items-center justify-center text-white text-xs font-semibold shadow-lg shadow-indigo-500/30",
  ...
  ctaButton:
    "group inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white font-semibold shadow-lg shadow-indigo-500/20 hover:from-indigo-500 hover:to-fuchsia-500 active:scale-[0.98] transition-all duration-300 text-sm sm:text-base flex-1 sm:flex-none justify-center",
  ...
  userAvatar:
    "w-12 h-12 rounded-2xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 flex items-center justify-center text-white font-semibold shadow-lg shadow-indigo-500/20 hover:scale-105 transition-all duration-300 cursor-pointer group",
  userAvatarBorder:
...
export const dashboardStyles = {
  ...
  // KPI Grid
  kpiGrid: "grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 lg:gap-6",

  // Main Content Grid
  mainGrid: "grid grid-cols-1 xl:grid-cols-4 gap-6 lg:gap-8",
  ...
  // Quick Stats Card
  quickStatsCard:
    "bg-gradient-to-b from-[#0F172A] to-[#161B33] rounded-2xl p-6 text-white ring-1 ring-white/5",
  ...
  quickActionBlue: "bg-indigo-50 text-indigo-700 hover:bg-indigo-100",
  ...
  tableActionButton:
    "mt-3 sm:mt-0 inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-indigo-600 hover:text-indigo-700 transition-colors duration-200",
  ...
  tableRow:
    "hover:bg-indigo-50/20 transition-colors duration-150 group cursor-pointer",
  tableCell: "px-6 py-4",

  // Client Avatar
  clientAvatar:
    "w-10 h-10 rounded-xl bg-indigo-100 flex items-center justify-center text-indigo-600 font-medium group-hover:scale-110 transition-transform duration-200",
  clientInfo:
  ...
  // Action Button
  actionButton:
    "inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-all duration-200 group/btn",
  ...
  emptyStateAction: "text-indigo-600 hover:text-indigo-700 font-medium",

  // Color variants for quick action icons
  quickActionIconBlue: "bg-indigo-100",
...
export const invoicesStyles = {
  ...
  createButton:
    "inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white font-semibold hover:from-indigo-500 hover:to-fuchsia-500 active:scale-[0.98] transition-all duration-200 shadow-lg shadow-indigo-500/20",
  ...
  filtersIconContainer: "p-2.5 rounded-xl bg-indigo-100 text-indigo-600",
  ...
  searchInput:
    "w-full rounded-xl border border-slate-200 pl-10 pr-4 py-3 bg-slate-50/50 focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200 text-slate-800",
  selectInput:
    "w-full rounded-xl border border-slate-200 px-4 py-3 bg-slate-50/50 focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200 text-slate-800",

  // Date Range
  dateRangeContainer: "lg:col-span-2",
  dateRangeFlex: "flex flex-col sm:flex-row sm:items-center gap-3",
  dateInput:
    "w-full sm:flex-1 min-w-0 rounded-xl border border-slate-200 px-4 py-3 bg-slate-50/50 focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200",
  ...
  perPageSelect:
    "rounded-xl border border-slate-200 px-4 py-2 bg-slate-50/50 focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200",
  resetButton:
  ...
  tableHeaderCellRight:
    "px-6 py-4 text-right text-xs font-semibold text-slate-500 uppercase tracking-wider",
  tableBody: "divide-y divide-slate-100",
  tableRow: "hover:bg-indigo-50/20 transition-colors duration-150 group",

  // Client Cell
  clientCell: "px-6 py-4",
  clientContainer: "flex items-center gap-4",
  clientAvatar:
    "w-12 h-12 rounded-xl bg-indigo-100 flex items-center justify-center text-indigo-600 font-medium group-hover:scale-110 transition-transform duration-200",
  clientInfo:
    "font-medium text-slate-900 group-hover:text-indigo-600 transition-colors",
  ...
  viewButton:
    "inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-all duration-200 group/btn",
  sendButton:
    "inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50 rounded-lg transition-all duration-200 group/btn",
...
export const featuresStyles = {
  ...
  backgroundBlob1:
    "absolute top-0 left-0 w-72 h-72 bg-indigo-100 rounded-full mix-blend-multiply filter blur-xl opacity-50 animate-blob",
  backgroundBlob2:
  ...
  badge:
    "inline-flex items-center px-4 py-2 rounded-full bg-indigo-50 border border-indigo-100 mb-6",
  badgeDot: "w-2 h-2 bg-indigo-500 rounded-full mr-2 animate-pulse",
  ...
  titleGradient: "text-indigo-600",
  subtitle:
    "mt-6 text-md md:text-xl lg:text-xl xl:text-xl text-slate-500 leading-relaxed max-w-2xl mx-auto",
  featuresGrid:
    "mt-16 grid grid-cols-1  lg:grid-cols-3 gap-6 lg:gap-8 relative",
  featureCard:
    "group relative bg-white/90 backdrop-blur-sm rounded-2xl p-8 border border-slate-200/70 shadow-sm hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-500 ease-out hover:-translate-y-2 overflow-hidden ring-1 ring-slate-900/5",
  featureCardGradient:
    "absolute inset-0 bg-indigo-50/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500",
  featureCardBorder:
    "absolute inset-0 rounded-2xl ring-1 ring-indigo-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500",
  featureCardContent: "relative flex items-start gap-6",
  featureCardIconContainer:
    "flex-shrink-0 w-10 h-10 lg:w-8 lg:h-8 xl:w-10 xl:h-10 flex items-center justify-center rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white shadow-lg shadow-indigo-500/20 group-hover:scale-110 transition-all duration-300",
  featureCardTextContainer: "flex-1",
  featureCardTitle:
    "text-sm whitespace-nowrap md:text-lg lg:text-sm xl:text-xl font-bold text-slate-900 group-hover:text-indigo-700 transition-colors duration-300",
  featureCardDescription:
    "mt-3 text-sm text-slate-500 leading-relaxed group-hover:text-slate-600 transition-colors duration-300",
  featureCardCta:
    "mt-4 flex items-center text-indigo-500 opacity-0 group-hover:opacity-100 transform translate-x-2 group-hover:translate-x-0 transition-all duration-300",
  ...
  bottomCtaButton:
    "group inline-flex items-center px-8 py-4 bg-gradient-to-r from-indigo-600 to-fuchsia-600 hover:from-indigo-500 hover:to-fuchsia-500 text-white font-semibold rounded-2xl shadow-lg shadow-indigo-500/20 hover:shadow-xl hover:shadow-indigo-500/25 active:scale-[0.98] transition-all duration-300",
...
export const heroStyles = {
  ...
  bgElement1:
    "absolute top-1/4 -left-10 w-72 h-72 rounded-full blur-3xl opacity-40 bg-indigo-200 animate-float-slow",
  bgElement2:
  ...
  badge:
    "inline-flex items-center gap-2 px-4 py-2 rounded-2xl bg-indigo-50 border border-indigo-100",
  ...
  primaryButton:
    "group relative inline-flex items-center justify-center gap-3 px-8 lg:px-10 py-4 lg:py-5 rounded-2xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white font-semibold shadow-xl shadow-indigo-500/25 hover:from-indigo-500 hover:to-fuchsia-500 hover:shadow-2xl hover:shadow-indigo-500/30 active:scale-[0.98] transition-all duration-300 overflow-hidden",
  ...
  featuresGrid: "grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6",
  featureItem: "flex items-center gap-3 group",
  featureIcon:
    "w-12 h-12 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-xl shadow-sm group-hover:scale-110 group-hover:border-indigo-200 group-hover:bg-indigo-50 transition-all duration-300",
  featureText: "",
  featureLabel: "font-semibold text-slate-900 whitespace-nowrap",
  featureDesc: "text-sm text-slate-500",
  demoColumn: "relative w-full",
  demoFloating1:
    "hidden sm:block absolute -top-6 -left-6 w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-2xl bg-indigo-100 blur-xl opacity-60 animate-float-slow pointer-events-none",
  demoFloating2:
  ...
  cardLogo:
    "w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 flex items-center justify-center text-white font-bold text-xs sm:text-sm shadow-lg shadow-indigo-500/20",
  ...
  itemDot:
    "w-2 h-2 sm:w-2 sm:h-2 rounded-full bg-indigo-500 group-hover/item:scale-150 transition-transform duration-300",
  ...
  totalValue: "text-indigo-600 text-lg sm:text-xl font-bold",
  ...
  sendButton:
    "flex-1 px-4 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white font-medium shadow-lg shadow-indigo-500/20 hover:from-indigo-500 hover:to-fuchsia-500 active:scale-[0.98] transition-all duration-200 group/btn text-sm sm:text-base",
  sendButtonText:
    "group-hover/btn:translate-x-1 transition-transform duration-200 inline-block",
  aiIndicator:
  ...
  cornerAccent1:
    "hidden sm:block absolute -top-2 -right-2 w-5 h-5 sm:w-6 sm:h-6 border-t-2 border-r-2 border-indigo-500 rounded-tr-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500",
  cornerAccent2:
  ...
  cardBackground:
    "absolute inset-0 -z-10 bg-indigo-50/20 rounded-2xl sm:rounded-3xl blur-xl transform scale-100 sm:scale-105",
  scrollIndicator:
...
export const invoicePreviewStyles = {
  ...
  headerInvoiceNumber: "font-semibold text-indigo-600",
  ...
  totalAmountValue: "text-lg font-bold text-indigo-600",
  ...
  emptyStateButton:
    "inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white font-semibold hover:from-indigo-500 hover:to-fuchsia-500 transition-all duration-200 shadow-lg shadow-indigo-500/20",
};

export const pricingStyles = {
  section: "relative py-24 bg-white overflow-hidden",
  bgElement1:
    "absolute top-0 left-0 w-72 h-72 bg-indigo-50 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob",
  bgElement2:
  ...
  grid: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 relative",
  ...
  featureDot: "w-2 h-2 rounded-full bg-indigo-500",
  faqCta: "mt-12 text-center",
  faqText: "text-slate-500 mb-6",
  contactLink:
    "text-indigo-600 font-semibold hover:text-indigo-700 transition-colors duration-300",
};
...
export const pricingCardStyles = {
  ...
  cardPopular:
    "border-indigo-300 border-2 shadow-2xl shadow-indigo-500/10 scale-105 overflow-visible z-10",
  cardRegular:
  ...
  popularBadgeContent:
    "bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white px-4 py-1 rounded-full text-sm font-semibold shadow-lg shadow-indigo-500/30",
  gradientOverlay:
    "absolute inset-0 bg-indigo-50/30 opacity-60 z-0 pointer-events-none rounded-3xl",
  animatedBorder:
    "absolute inset-0 rounded-3xl ring-1 ring-indigo-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10",
  ...
  featureIconPopular: "bg-indigo-100 text-indigo-600",
  ...
  ctaButtonPopular:
    "bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white shadow-lg shadow-indigo-500/20 hover:from-indigo-500 hover:to-fuchsia-500 hover:shadow-xl hover:shadow-indigo-500/25 active:scale-[0.98]",
  ctaButtonRegular:
  ...
  cornerAccent1:
    "absolute -top-2 -right-2 w-6 h-6 border-t-2 border-r-2 border-indigo-500 rounded-tr-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-30",
  cornerAccent2:
...
export const authStyles = {
  pageContainer:
    "min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/40 text-slate-800 antialiased",
  ...
  input:
    "w-full rounded-xl border border-slate-200 px-3 py-2.5 outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200 bg-slate-50/50 text-slate-800",
  passwordContainer: "relative",
  passwordInput:
    "w-full rounded-xl border border-slate-200 px-3 py-2.5 pr-10 outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 transition-all duration-200 bg-slate-50/50 text-slate-800",
  passwordToggle:
  ...
  submitButton:
    "w-full inline-flex justify-center items-center px-4 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white font-medium hover:from-indigo-500 hover:to-fuchsia-500 active:scale-[0.98] transition-all duration-200 shadow-lg shadow-indigo-500/20",
  ...
  footerLink: "text-indigo-600 hover:text-indigo-700 font-medium",
  eyeIcon: "w-5 h-5",
  eyeOffIcon: "w-5 h-5",
};
...
export const navbarStyles = {
  ...
  navLink: "text-sm hover:text-indigo-600 transition-colors duration-200",
  navLinkInactive:
  ...
  signUpButton:
    "group relative inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white font-semibold shadow-lg shadow-indigo-500/20 hover:from-indigo-500 hover:to-fuchsia-500 active:scale-[0.98] transition-all duration-300 overflow-hidden",
  signUpOverlay:
    "absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300",
  ...
  mobileSignUp:
    "block mt-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white text-center font-medium shadow-lg shadow-indigo-500/20",
};

export const kpiCardStyles = {
  cardContainer:
    "group relative bg-white/90 backdrop-blur-xl rounded-2xl p-6 border border-slate-200/70 shadow-sm ring-1 ring-slate-900/5 hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-500 ease-out hover:scale-[1.02] hover:border-slate-300/60 overflow-hidden",
  animatedBackground:
    "absolute inset-0 bg-indigo-50/0 group-hover:bg-indigo-50/30 transition-all duration-500 ease-out",
  cornerAccent:
    "absolute top-0 right-0 w-16 h-16 bg-indigo-500/3 rounded-bl-2xl",
  ...
  iconColors: {
    ...
    growth: "from-fuchsia-500 to-fuchsia-600",
...
export const loginStyles = {
  root: "min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/40 text-slate-800 antialiased",
  ...
  rememberCheckbox: "rounded border-slate-200 accent-indigo-600",
  rememberText: "text-slate-600",
  forgotPassword: "text-indigo-600 hover:text-indigo-700 font-medium",
  submitButton:
    "w-full inline-flex justify-center items-center px-4 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-fuchsia-600 text-white font-medium hover:from-indigo-500 hover:to-fuchsia-500 active:scale-[0.98] transition-all duration-200 shadow-lg shadow-indigo-500/20",
  signupContainer: "mt-6 text-center text-sm text-slate-500",
  signupLink: "text-indigo-600 hover:text-indigo-700 font-medium",
};
...
export const footerStyles = {
  ...
  link: "text-sm md:text-sm lg:text-base text-slate-500 hover:text-indigo-600 transition-colors duration-200",
};
